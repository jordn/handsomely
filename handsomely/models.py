...
class Request(models.Model):
	customerID = models.IntegerField() #FK
	salonID = models.IntegerField() #FK
	startDate = models.DateTimeField(_("Date"), auto_now_add=True)
	STATUSES = ( 
	...
	noSoonerThan = models.DateTimeField(_("Date"), auto_now_add=True)

class Notifications(models.Model):
	customerID = models.IntegerField() #FK
	salonID = models.IntegerField() #FK
	timeSent = models.DateTimeField(_("Date"), auto_now_add=True)
	timeReplied = DateTimeField(_("Date"), auto_now_add=True)
	STATUSES = ( 
		('PEN', 'Pending'),
		('ACC', 'Accepted'),
		('CAN', 'Cancelled'),
