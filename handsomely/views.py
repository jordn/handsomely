...
def emailtest(request):
	...
	message += ' is now free, why not head down now to avoid a queue?\n'
	message += ' Your response: <a href=\"http://www.handsome.ly/response?ans=YES\">YES</a> <br/> <a href=\"http://www.handsome.ly/response?ans=NO\">NO</a> <br/> <a href=\"http://www.handsome.ly/response?ans=CANCEL\">CANCEL</a> <br/>'
