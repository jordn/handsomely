...
def response(request):
	...
	if djangoUser.is_anonymous():
		...
		if (handsomelyUserFromNotification.djangoUserID == djangoUser.id):
			...
			return render_to_response('incorrect_user.html', {'answer' : answer, 'notifID' : notifID, 'message' : message, 'djuid' : djangoUser.id, 'handsomelyUserFromNotification.djangoUserID' :  }, context_instance=RequestContext(request))
