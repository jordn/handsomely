...
def notify_customers(request):
	...
	reqIds = []
	notif = Notification(salon_id=salon, status='OPEN', appointment_date_time=datetime.datetime.now, appointment_price=10.5, original_price=11, haircut_type="M", additional_info="testing")
